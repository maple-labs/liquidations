...
interface IUniswapV2StyleStrategy {
    ...
    /**
     * @notice Function that calls `liquidatePortion` in the liquidator, flash-borrowing funds to swap.
    ...
    /**
     * @notice Function that performs a `swapExactTokensForTokens` swap on a UniswapV2-style AMM, sending the remaining funds
